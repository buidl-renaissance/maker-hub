...
// Use community config for branding
const APP_NAME = communityConfig.name;
const APP_TAGLINE = communityConfig.tagline;
const APP_DESCRIPTION = communityConfig.description;
